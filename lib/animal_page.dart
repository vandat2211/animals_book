...
class _AnimalPageState extends State<AnimalPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: CustomAppBar(
          context,
          title:widget.drawer? Text(
            widget.name_dacdiem + '(${widget.name_species.toLowerCase()})',
            style: TextStyle(fontSize: 18),
          ):Text(
            widget.name_dacdiem + '(${widget.name_classify.toLowerCase()})',
            style: TextStyle(fontSize: 18),
          ),
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => DeltailPage(
                          ...
                          from_animal_page: true,
                          name_dacdiem: widget.name_dacdiem,
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image:widget.drawer? NetworkImage(widget.url_species):NetworkImage(widget.url_classify),
                                      fit: BoxFit.cover),
                          ...
                          Expanded(
                            ...
                            child:  SingleChildScrollView(
                              child: Html(
                                data:widget.drawer?widget.describe_species: widget.describe_classify,
                                style: {
                                  "#": Style(
                                      ...
                                      footer: Material(
                                        ...
                                        child: Container(
                                          ...
                                          child: GridTileBar(
                                            ...
                                            title:docIDs[index]['name_animal_el']==null? Text(
                                              '${docIDs[index]['name_animal']}',overflow: TextOverflow.clip,)
                                            :Text(
                                                '${docIDs[index]['name_animal_el']}',overflow:TextOverflow.clip ,),
                                            subtitle: Text(
                                                '${docIDs[index]['name_animal']}',overflow: TextOverflow.clip,),
                                          ),
                                        ),
                      ...
                      Expanded(
                        flex: 2,
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return ListTile(
                                  leading:Image.network(list_species[index]['icon_species'].toString(),width: 24,height: 24,),
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => AnimalPage(
                                            ...
                                            url_dacdiem: widget.url_dacdiem,
                                            name_dacdiem: widget.name_dacdiem,
                                            name_classify: widget.name_classify,
                                            describe: widget.describe,
                                            url_classify: widget.url_classify,
                                            describe_classify: widget.describe_classify,
                                            describe_species: list_species[index]['describe_species'],
                                            url_species: list_species[index]['url_species'], drawer: true,
                                            name_species: list_species[index]['name_species'],
                                          )),
                                    );
                                  },
                                );
